 ...
 * @author ADMIN
 */
public class SwitchButton  extends Component implements TableCellRenderer{
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
      SwitchButton de = new SwitchButton();
      
      de.setSelected(isSelected);
//      de.setBackground(table.getSelectionBackground());
